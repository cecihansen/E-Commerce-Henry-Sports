...
import passwordSettings from './usuario/ChangePassword.js'
import userSettings from './usuario/DatosUserSettings.js'
  ...
  return (
    <div>
      <div className="App">
        ...
        <Route exact path="/User/configuracion" component={passwordSettings} />
